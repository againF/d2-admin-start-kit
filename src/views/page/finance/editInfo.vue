<template>
  <div class="full-height">
    <page-header head-text="修改收款信息" :show-right-btn="false" />
    <div class="padding-wrap">
      <div class="width-limit">
        ...
        <div @click="submitForm('ruleForm')" class="add-btn">保存</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.ruleForm.companyName = this.$route.params.name;
    this.ruleForm.tax = this.$route.params.nocode;
    this.ruleForm.local = this.$route.params.address;
    this.ruleForm.phone = this.$route.params.phone;
    this.ruleForm.bankAccount = this.$route.params.cardcode;
    this.ruleForm.bankName = this.$route.params.bankname;
  },
  methods: {
    submitForm(formName) {
